...
| `radius.circular` | `radius.circular` | 100% | Elementos circulares |
...
- `full` é para elementos alongados (badges, chips, botões pílula); `circular` é para elementos quadrados (avatares, botões de ícone).
