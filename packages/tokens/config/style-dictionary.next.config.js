...
// Tokens core são "include" — resolvem aliases mas não geram output próprio
// Tokens semantic e components são "source" — geram output
const base = {
  include: [
    'src/core/**/*.json'
  ],
...
const sdBase = new StyleDictionary(base);
