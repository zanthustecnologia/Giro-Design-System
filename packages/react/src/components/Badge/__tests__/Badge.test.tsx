...
describe('Badge', () => {
  ...
  describe('com children (modo overlay)', () => {
    ...
    describe('Classes CSS', () => {
      ...
      it('aplica badge__small para valores com 1 caractere', () => {
        render(<Badge badgeValue={5}><span>x</span></Badge>);
        const badge = screen.getByTestId('badge');
        expect(badge.className).toMatch(/badge__small/);
      });

      it('aplica badge__large para valores com 2 ou mais caracteres', () => {
  ...
  describe('sem children (modo inline)', () => {
    ...
    describe('Classes CSS', () => {
      ...
      it('aplica badge__status__large para valores com mais de 1 caractere', () => {
        render(<Badge badgeValue={150} />);
        const badge = screen.getByTestId('badge');
        expect(badge.className).toMatch(/badge__status__large/);
      });

      it('não aplica badge__status__large para valores com 1 caractere', () => {
        render(<Badge badgeValue={5} />);
        const badge = screen.getByTestId('badge');
