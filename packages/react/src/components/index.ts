...
export { default as G_TextArea } from './TextArea';
export { type TextAreaProps } from './TextArea/TextArea.types';

export { default as TextField } from './TextField';
export { default as G_TextField } from './TextField';
...
export { default as G_Tooltip } from './Tooltip';
export { type TooltipProps } from './Tooltip/Tooltip.types';

export { default as Switch } from './Switch';
export { default as G_Switch } from './Switch';
export { type SwitchProps } from './Switch/Switch.types';

export { default as ToggleButton } from './ToggleButton';
export { default as G_ToggleButton } from './ToggleButton';
...
export { default as G_VerificationCode } from './VerificationCode';
...
export { default as G_VirtualKeyboard } from './VirtualKeyboard';
